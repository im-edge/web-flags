...
```bash
REVISION=02b8adc
wget -q -O - https://raw.githubusercontent.com/lipis/flag-icons/$REVISION/css/flag-icons.css | sed -r 's#../flags#../img/inventory/vendor/flags#g' > public/css/flag-icons.less
